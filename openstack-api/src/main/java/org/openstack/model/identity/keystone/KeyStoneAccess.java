...
@XmlRootElement(name = "access", namespace="http://docs.openstack.org/identity/api/v2.0")
@XmlAccessorType(XmlAccessType.NONE)
public class KeyStoneAccess implements Access, Serializable {
    @XmlElement(nillable = true, name = "service", namespace="http://docs.openstack.org/identity/api/v2.0", type = KeyStoneService.class)
    @XmlElementWrapper(namespace="http://docs.openstack.org/identity/api/v2.0", name = "serviceCatalog")
    ...
    @XmlElement(namespace="http://docs.openstack.org/identity/api/v2.0", type = Token.class)
    private Access.Token token;

    @XmlElement(namespace="http://docs.openstack.org/identity/api/v2.0", type = KeyStoneUser.class)
    public User user;
